...
미술대학 일부 교수는 공식 미술대학 교수 페이지 구조를 직접 확인하여 전시 정보가 상세페이지에 표시되도록 보완했습니다. 다른 계열도 전체 순회 후 공식 페이지와의 표본 대조를 통해 필요한 경우에만 분야/사이트별 adapter를 보완합니다.
...
- `dist/app.js` 및 `dist/*hotfix*.js` — 공개 앱 UI/보완 로직
