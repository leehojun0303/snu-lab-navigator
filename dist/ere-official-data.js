(function(){
  ...
  window.PRECOMPUTED_ENRICHMENT[id]={
    ...
    recent_papers:[
      {title:'Improvement of spectrum suppression-based deep learning interpolation technique',year:'2023',venue:'IEEE Transactions on Geoscience and Remote Sensing',url:official,summary:'딥러닝 기반 결측 탄성파 자료 보간에서 스펙트럼 억제를 개선해 복원 정확도를 높이는 연구입니다.'},
      {title:'Analysis of sensitivity patterns for characteristics of magnetotelluric (MT) response functions in inversion',year:'2023',venue:'Geophysical Journal International, 233(3), 1746-1771',url:official,summary:'MT 역산 응답함수의 민감도 패턴을 분석해 지하 전기비저항 구조 해석 특성을 규명한 연구입니다.'},
      {title:'Synthetic modeling and field GPR survey to understand the near-surface deformation induced by coseismic groundwater dynamics following the 2019 Mirpur earthquake in Pakistan',year:'2022',venue:'The Leading Edge, 41(8), 529-539',url:official,summary:'합성 모델링과 현장 GPR 탐사를 이용해 미르푸르 지진 이후 지하수 관련 천부 변형을 분석한 연구입니다.'}
    ],
